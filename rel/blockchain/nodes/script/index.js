...
// -----------------------------------------------------------------------------------
// Horizontal Chart Nodes Ranking Section
new Chart(document.getElementById("chartRankingNodes"), {
  type: "horizontalBar",
  data: {
    labels: [
      "United State",
    ...
    datasets: [
      {
        ...
        data: [
          1786, 1450, 605, 595, 482, 227, 123, 103, 99, 97, 89, 86, 79, 63, 61,
          55, 54, 52, 51, 50, 46, 43, 22, 16, 15, 14, 14, 11, 156,
        ],
      },
    ],
  },
